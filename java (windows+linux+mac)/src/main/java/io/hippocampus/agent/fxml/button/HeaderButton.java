...
public class HeaderButton extends MenuButton {
    ...
    private static final String TITLE_LOAD_BACKUP
            = "Select a backup file (.hippos) to load hippo\'s from";
    private static final String TEXT_CREATE_BACKUP = "Create backup ";
    private static final String TITLE_CREATE_BACKUP
    ...
    private void setEvents() {
        super.setOnMouseEntered((MouseEvent t) -> {
            instance.setId(ID_HOVER);
        });

        super.setOnMouseExited((MouseEvent t) -> {
            instance.setId(null);
        });
    }
