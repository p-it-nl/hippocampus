...
public class HippoBackupLoader {
    ...
    private final String DATA_BACKUP_FILE_NAME = "hippo.hippos";
    ...
    public void loadHipposFromBackUp(final HippoData hippoData,
        ...
        if (hippoData != null) {
            try {
                ...
                LOGGER.log(ERROR, "Exception occurred trying to read a backup file", ex);
    ...
    private File getBackupFile() throws FileNotFoundException {
    ...
    private File determineBackupFile(final File file) throws FileNotFoundException {
        if (file == null) {
