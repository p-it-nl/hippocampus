...
public class ApplicationData {
    ...
    private static final String APP_DIR_PATH_MAC = "/Library/Application Support/";//NOSONAR, this is not and should not be customizable
    private static final String APP_DIR_PATH_LINUX = "/.";//NOSONAR, this is not and should not be customizable
    private static final String APP_DIR_PATH_WINDOWS = "/";//NOSONAR, this is not and should not be customizable
    ...
    /**
     * Get the application data location based on the OS the application is
     * running on
     *
