...
public class HippoLoader {
    ...
    private static final String HIPPO_LIST_ID = "#hippoList";
    private static final String HIPPO_SCROLL_ID = "#scrollPane";
    private static final String HIPPO_WRAPPER_ID = "hippo";
    private static final String HIPPO_ROW_TEXT = "row-text";
    ...
    public void clearHipposFromScreen(final Scene scene) {
        if (scene != null) {
            ...
            Platform.runLater(() -> contentWrapper.getChildren().clear());
        } else {
            // No scene, no action
        }
    }
