 ...
 * @author Patrick-4488
 */
public class MatchesIdAndVersionPredicate implements Predicate<Hippo> {

    private final Map<Long, Long> map;

    public MatchesIdAndVersionPredicate() {
        map = new HashMap<>();
    }
     ...
     * @return this fluent
     */
    public MatchesIdAndVersionPredicate addToMap(final Long id, final Long version) {
        map.put(id, version);
